        ...
        <section className="mb-20">
          <div className="text-center mb-10">
            <div className="inline-flex items-center gap-2 mb-3">
              ...
              <h2 className="text-2xl font-bold text-white">Advanced Market Charts</h2>
            </div>
            <p className="text-gray-400 max-w-2xl mx-auto">
              Interactive TradingView charts for major indices with multiple timeframes
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 border border-slate-700 rounded-2xl p-6 backdrop-blur-sm hover:border-blue-500/30 transition-all duration-300">
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-white font-semibold text-lg">NASDAQ</h3>
                    <p className="text-blue-400 text-sm">IXIC Composite</p>
                  </div>
                </div>
                <span className="text-cyan-400 font-medium">NASDAQ:IXIC</span>
              </div>
              <div className="h-64 rounded-xl overflow-hidden">
                <div className="tradingview-widget-container" style={{ height: "100%" }}>
                  <div id="tradingview-nasdaq-chart-container" style={{ height: "calc(100% - 32px)" }}>
                    <div className="tradingview-widget-container__widget"></div>
                  </div>
                  <div className="tradingview-widget-copyright">
                    <a href="https://www.tradingview.com/symbols/NASDAQ-IXIC/" rel="noopener nofollow" target="_blank">
                      <span className="text-cyan-400">IXIC chart</span>
                    </a>
                    <span className="text-gray-400"> by TradingView</span>
                  </div>
                </div>
            ...
            {/* S&P 500 Chart */}
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 border border-slate-700 rounded-2xl p-6 backdrop-blur-sm hover:border-green-500/30 transition-all duration-300">
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-white font-semibold text-lg">S&P 500</h3>
                    <p className="text-green-400 text-sm">SPX Index</p>
                  </div>
                </div>
                <span className="text-cyan-400 font-medium">VANTAGE:SP500</span>
              </div>
              <div className="h-64 rounded-xl overflow-hidden">
                <div className="tradingview-widget-container" style={{ height: "100%" }}>
                  <div id="tradingview-sp500-chart-container" style={{ height: "calc(100% - 32px)" }}>
                    <div className="tradingview-widget-container__widget"></div>
                  </div>
                  <div className="tradingview-widget-copyright">
                    <a href="https://www.tradingview.com/symbols/VANTAGE-SP500/" rel="noopener nofollow" target="_blank">
                      <span className="text-cyan-400">SP500 chart</span>
                    </a>
                    <span className="text-gray-400"> by TradingView</span>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 border border-slate-700 rounded-2xl p-6 backdrop-blur-sm hover:border-orange-500/30 transition-all duration-300">
              <div className="flex justify-between items-center mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-white font-semibold text-lg">SENSEX</h3>
                    <p className="text-orange-400 text-sm">BSE Index</p>
                  </div>
                </div>
                <span className="text-cyan-400 font-medium">BSE:SENSEX</span>
              </div>
              <div className="h-64 rounded-xl overflow-hidden">
                <div className="tradingview-widget-container" style={{ height: "100%" }}>
                  <div id="tradingview-sensex-chart-container" style={{ height: "calc(100% - 32px)" }}>
                    <div className="tradingview-widget-container__widget"></div>
                  </div>
                  <div className="tradingview-widget-copyright">
                    <a href="https://www.tradingview.com/symbols/BSE-SENSEX/" rel="noopener nofollow" target="_blank">
                      <span className="text-cyan-400">SENSEX chart</span>
                    </a>
                    <span className="text-gray-400"> by TradingView</span>
                  </div>
                </div>
